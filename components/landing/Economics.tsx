...
export function Economics() {
  return (
    <Block
      ...
      lede="Pay as you go. Every generation was a metered API call, so we knew the cost to the cent."
    >
      ...
      <div className="mt-16 grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7">
          ...
          <dl className="mt-4 border-t rule">
            {market.map((m) => (
              <div key={m.label} className="flex items-baseline gap-6 border-b rule last:border-b-0 py-4">
        ...
        <div className="lg:col-span-5">
          ...
          <dl className="mt-4 border-t rule">
            {marketerUse.map((m) => (
              <div key={m.what} className="flex items-baseline gap-6 border-b rule last:border-b-0 py-4">
